 ...
 * @param {Stream} notifyStream to be left null, unless connecting with an old Proxy Data Adapter,
 * based on two-connections behavior, to achieve backward compatibility with Server version earlier than 7.4,
