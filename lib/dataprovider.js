 ...
 * If needed, the supplied object should contain both a "user" and a "password" field, in order for the
 * credentials to be sent; otherwise, null can be specified.
...
function DataProvider(reqRespStream, notifyStream, isSnapshotAvailable, credentials, keepaliveInterval) {
	...
	var credentialParams = baseProto.getCredentials(credentials);
