 ...
 * <li>getUserItemData: for each item returns the configured allowedBufferSize, allowedMaxItemFreq,
 *     and {raw: true, merge: true, distinct: true, command: true} as the allowed modes</li>
...
function MetadataResponse(stream, message, writeSuccess, writeError) {
	 ...
	 * to issue a proper type of exceptiond depends on the event handled as described in the following table:
	 * <ul>
	 * <li>init: "metadata"</li>
