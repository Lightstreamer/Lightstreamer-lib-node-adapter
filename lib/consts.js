...
exports.globals = {
	...
	EOM : "\n",
	// Notification of the SDK name to be sent
	SDK_NAME : "Node.js Adapter SDK",
};
...
exports.types = {
	...
	MODE : 'M',
	// "diff" algorithm type identifier
	DIFF_ALGORITHM : 'F',
...
// Protocol field "diff" algorithms encodings.
exports.algValues = {
	// Encoded "diff" algorithm for fields that support delta delivery with the JSON Patch format
	JSONPATCH : 'J',
	// Encoded "diff" algorithm for fields that support delta delivery with the TLCP-diff format
	// (computed with Google's diff-match-patch algorithm)
	DIFF_MATCH_PATCH : 'M',
};
...
exports.dataMethods = {
	...
	UPDATE_BY_MAP : "UD3",
	// Declare field "diff" order event message method
	DECLARE_FIELD_DIFF_ORDER : "DFD",
};
