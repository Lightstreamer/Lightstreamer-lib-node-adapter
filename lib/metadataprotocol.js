...
exports.metadata = {
	...
	writeNotifyUserException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_USER, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyUserAuthException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_USER_AUTH, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyUserMessageException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_USER_MESSAGE, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyNewSessionException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_NEW_SESSION, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyNewTablesException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_NEW_TABLES, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyMpnDeviceAccessException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_MPN_DEVICE_ACCESS, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyMpnSubscriptionActivationException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_MPN_SUBSCRIPTION_ACTIVATION, exceptionMessage, exceptionType);
	},
	/**
	...
	writeNotifyMpnDeviceTokenChangeException : function(requestId, exceptionMessage, exceptionType) {
		return writeSimpleException(requestId, metadataMethods.NOTIFY_MPN_DEVICE_TOKEN_CHANGE, exceptionMessage, exceptionType);
	},
};
