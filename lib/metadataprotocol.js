...
exports.metadata = {
	/**
	 * Extracts the supplied credentials and adds them to the init parameters (since 1.8.1).
	 *
	 * @param {Object} parameters key-value pairs
	 * @param {Object} credentials key-value pairs
	 * @private
	 */
	addCredentials : function(paramaters, credentials) {
		if (credentials[specialParameters.USER] != null) {
			paramaters[specialParameters.USER] = credentials[specialParameters.USER];
		}
		if (credentials[specialParameters.PASSWORD] != null) {
			paramaters[specialParameters.PASSWORD] = credentials[specialParameters.PASSWORD];
		}
	},
	/**
