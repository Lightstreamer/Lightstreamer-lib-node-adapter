...
var protocol =  require('./protocol'),
	baseProtocol =  require('./baseprotocol'),
	types = require('./consts').types,
	exceptions = require('./consts').exceptions,
	dataMethods = require('./consts').dataMethods,
	commonMethods = require('./consts').commonMethods,
	specialRequestIDs = require('./consts').specialRequestIDs;
...
exports.data = {
	...
	/**
	 * Encodes a notification stream credentials message (since 1.8.2).
	 *
	 * @param {Object} parameters the credentials name-value pairs
	 * @return {String} the encoded message
	 * @private
